...
console.assert(negativos === 2, "Error en cantidad de negativos");
console.assert(positivos === 2, "Error en cantidad de positivos");
console.assert(ceros === 1, "Error en cantidad de ceros");
...
console.assert(avg[0] === 20, "Error en promedio fila 1");
console.assert(avg[1] === 20, "Error en promedio fila 2");
console.assert(avg[2] === 150, "Error en promedio fila 3");
...
console.assert(invertidoNum === 54321, "Error al invertir el número");
...
let nombreDisco = "DATA";
let artistaDisco = "Tainy";
let cancionesDisco = 16;
...
console.assert(miDisco.descripcion() === 'El disco "DATA" de Tainy tiene 16 canciones.', "Error en método descripcion");
console.assert(miDisco.duracionTotal() === 56, "Error en método duracionTotal");
